...
<div class="stock-container info-container m-t-10">
								...
								<select   name="productAvailability"  id="productAvailability" class="span8 tip" required style="margin-top:10px;">
<option value="" >Select Size for Clothes only</option>
<option value="In Stock">Small</option>
<option value="Out of Stock">Medium</option>
<option value="Out of Stock">Large</option>
<option value="Out of Stock">Extra Large</option>
</select>
